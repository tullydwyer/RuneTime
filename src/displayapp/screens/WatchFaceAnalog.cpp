...
WatchFaceAnalog::WatchFaceAnalog(Controllers::DateTime& dateTimeController,
  ...
  lv_obj_set_style_local_scale_end_color(major_scales, LV_LINEMETER_PART_MAIN, LV_STATE_DEFAULT, Colors::parchment);
  ...
  lv_obj_set_style_local_scale_end_color(large_scales, LV_LINEMETER_PART_MAIN, LV_STATE_DEFAULT, Colors::gold);
  ...
  lv_obj_set_style_local_text_color(twelve, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::gold);
  ...
  lv_obj_set_style_local_text_color(notificationIcon, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::green);
  ...
  lv_style_set_line_color(&second_line_style, LV_STATE_DEFAULT, Colors::deepOrange);
  ...
  lv_style_set_line_color(&minute_line_style, LV_STATE_DEFAULT, Colors::parchment);
  ...
  lv_style_set_line_color(&minute_line_style_trace, LV_STATE_DEFAULT, Colors::parchment);
  ...
  lv_style_set_line_color(&hour_line_style, LV_STATE_DEFAULT, Colors::parchment);
  ...
  lv_style_set_line_color(&hour_line_style_trace, LV_STATE_DEFAULT, Colors::parchment);
