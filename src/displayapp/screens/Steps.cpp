...
Steps::Steps(Controllers::MotionController& motionController, Controllers::Settings& settingsController)
  ...
  lv_obj_set_style_local_text_color(lSteps, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::green);
  ...
  lv_label_set_text_static(lstepsL, "Agility / steps");
  ...
  lv_obj_set_style_local_text_color(lstepsGoal, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::blue);
  lv_label_set_text_fmt(lstepsGoal, "Quest: %5lu", settingsController.GetStepsGoal());
  ...
  lv_obj_set_style_local_radius(resetBtn, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, 2);
  ...
  lv_obj_set_style_local_text_color(tripLabel, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::gold);
